...
@section ('tab-js')
	<script type="text/javascript">
			...
			function dragend(e){
				...
				console.log(string);
				$.ajax({
				        url: "{{ route($route.'.order-location') }}",
				        type: 'POST',
				        data: {string:string},
						...
						<td style="white-space: nowrap; width: 1%;">
							<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
	                           	<div class="btn-group btn-group-sm" style="float: none;">
	                           		...
	                           		<a href="#" onclick="deleteConfirm('{{ route($route.'.trash', ['id'=>$id, 'location_id'=>$row->id]) }}', '{{ route($route.'.index', ['id'=>$id]) }}')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
