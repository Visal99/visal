		...
		<div class="tabs-section-nav tabs-section-nav-icons">
			<div class="tbl">
				<ul class="nav" role="tablist">
					...
					<li class="nav-item">
						<a class="nav-link @yield ('tab-active-access')" onclick="window.location.href='{{ route($route.'.accesses', $id) }}' " href="#" role="tab" data-toggle="tab">
							<span class="nav-link-in">
								<i class="fa fa-sticky-note-o"></i> Property Access
							</span>
						</a>
					</li>
