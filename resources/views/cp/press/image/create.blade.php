...
@section ('section-title', 'Add Image')
...
@section ('section-js')
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="http://via.placeholder.com/960x640" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 960x640 with .jpg or .png type</i></span>',
