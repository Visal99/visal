...
<head>
   ...
   <!-- CSS Unify Theme -->
   <link rel="stylesheet" href="{{asset('/css/styles.bm-classic.css')}}">
...
<main>
   ...
   <header id="js-header" class="u-header u-header--static u-shadow-v19">
      <div>
         <img class="d-none d-sm-block img-responsive" src="{{asset('/img/banner.jpg')}}" alt="banner"/>
         <img class="d-block d-sm-none img-responsive" src="{{asset('/img/1.png')}}" alt="1"/>
   ...
   <footer class="g-bg-secondary">
      <div class="g-brd-bottom g-brd-secondary-light-v2 g-py-50 g-mb-50">
         <div class="container">
            <h3 class="h6 g-font-primary g-font-weight-700 text-uppercase mb-3">Our Website</h3>
            ...
            <div class="js-carousel g-mx-minus-10"
               ...
               <div class="js-slide g-px-10">
                  ...
                  <article class="media g-bg-white g-pa-10">
                     <figure class="d-flex g-width-70 g-height-70 g-pos-rel mr-3">
                        <img class="img-fluid" src="img-temp/230x230/img6.jpg" alt="Image Description">
               ...
               <div class="js-slide g-px-10">
                  ...
                  <article class="media g-bg-white g-pa-10">
                     <figure class="d-flex g-width-70 g-height-70 mr-3">
                        <img class="img-fluid" src="img-temp/230x230/img7.jpg" alt="Image Description">
                     </figure>
            ...
            <div class="row align-items-center">
               <div class="col-md-4 g-hidden-sm-down g-mb-30">
                  ...
                  <a href="bm-classic-home-2.html">
                     <img class="g-width-150" src="img/logo.png" alt="Logo">
                  </a>
                  <!-- End Logo -->
               </div>
...
<script src="{{asset('/js/components/hs.onscroll-animation.js')}}"></script>
