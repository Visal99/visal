        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-md-8">
                    ...
                    <div class="page-header">
                        <h1 class="font-i padding-left1">@if(!empty($category)) {{ __('general.'.$category) }}@endif <small>   </small></h1>
                    </div>
                			...
                			<div class="blog-post style-two">
                                <div class="row clearfix">
                                    ...
                                    <div class="image-column col-md-4">
                                        <div class="image">
                                            <a href="{{ route('press-view', ['locale'=>$locale, 'category'=>$category, 'slug'=>$row->slug]) }}"><img src="{{ asset ($row->feature_image)}}" alt=""></a>
                                        </div>
                                    </div>
                                    <!--Content Column-->
                                    <div class="content-column col-md-8">
                                        <div class="inner">
                                            <div class="upper-box">
                                                ...
                                                <a href="{{ route('press-view', ['locale'=>$locale, 'category'=>$category, 'slug'=>$row->slug]) }}" class="font-i2">
                                                    {{$row->title}}
                                                </a>
                                            </div>
                                            <div class="lower-box">
                                                ...
                                                <div class="">
                                                  <a href="{{ route('press-view', ['locale'=>$locale, 'category'=>$category, 'slug'=>$row->slug]) }}"><span style="color: #003399;" class="view_more">{{__('general.read-more')}}<i style="color: #003399;" class=" fa fa-angle-right" aria-hidden="true"></i></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
