...
@section ('appbottomjs')
	<script type="text/javascript">
		...
		function updateStatus(id){
         	...
         	$.ajax({
		        url: "{{ route('user.presses.update-status') }}",
		        method: 'POST',
	...
	<script type="text/javascript">
		...
		function search(){
			...
			$(location).attr('href', '{{ route('user.presses.list') }}'+url);
		}
	</script>
@endsection
			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						<a href="{{ route('user.presses.list') }}"  class="tabledit-delete-button btn btn-sm btn-success" style="float: none;"><span class="fa fa-refresh"></span></a>
												...
												<td style="white-space: nowrap; width: 1%;">
													<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
			                                           	<div class="btn-group btn-group-sm" style="float: none;">
			                                           		<a href="{{ route('user.presses.edit', $row->id) }}" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;"><span class="glyphicon glyphicon-pencil"></span></a>
			                                           		
			                                           		<a href="#" onclick="deleteConfirm('{{ route('user.presses.trash', $row->id) }}', '{{ route('user.presses.list') }}')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
			                                           	</div>
			                                       </div>
			                                    </td>
											</tr>
