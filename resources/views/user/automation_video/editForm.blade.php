...
@section('title', 'Update Automation Video')
...
@section ('appbottomjs')
	<script type="text/JavaScript">
		$(automation-video).ready(function(event){
			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						<a href="{{ route('user.automation-video.list') }}"  class="tabledit-delete-button btn btn-sm btn-primary" style="float: none;"><span class="fa fa-arrow-left"></span></a>
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="container-fluid">
					...
					@endif
					<form id="form" action="{{ route('user.automation-video.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								...
								<button type="button" onclick="deleteConfirm('{{ route('user.automation-video.trash', $data->id) }}', '{{ route('user.automation-video.list') }}')" class="btn btn-danger"> <fa class="fa fa-trash"></i> Delete</button>
							</div>
						</div>
					</form>
				</div>
