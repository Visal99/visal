...
@section('title', 'Edit Automation Location')
...
@section ('appbottomjs')
	<script type="text/javascript">
		...
		function updateStatus(id){
         	...
         	$.ajax({
		        url: "{{ route('user.automation-location.update-status') }}",
		        method: 'POST',
	...
	<script type="text/javascript">
		...
		function search(){
			...
			$(location).attr('href', '{{ route('user.automation-location.list') }}'+url);
		}
	</script>
@endsection
			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						<a href="{{ route('user.automation-location.list') }}"  class="tabledit-delete-button btn btn-sm btn-success" style="float: none;"><span class="fa fa-refresh"></span></a>
						<a href="{{ route('user.automation-location.create') }}"  class="tabledit-delete-button btn btn-sm btn-primary" style="float: none;"><span class="fa fa-plus"></span></a>
					</div>
				</div>
			</div>
		</div>
