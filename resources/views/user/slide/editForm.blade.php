			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						<a href="{{ route('user.slide.list') }}"  class="tabledit-delete-button btn btn-sm btn-primary" style="float: none;"><span class="fa fa-arrow-left"></span></a>
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="container-fluid">
					...
					@endif
					<form id="form" action="{{ route('user.slide.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
