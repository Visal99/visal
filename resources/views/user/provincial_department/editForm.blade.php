...
@section('title', 'Update Provincial Department')
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="container-fluid">
					...
					@endif
					<form id="form" action="{{ route('user.provincial-department.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
