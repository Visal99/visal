...
<head>
    ...
    <link rel="stylesheet" href="{{asset('vendor/hs-admin-icons/hs-admin-icons.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('vendor/flatpickr/dist/css/flatpickr.min.css')}}">

    <link rel="stylesheet" href="{{asset('vendor/bootstrap-select/css/bootstrap-select.min.css')}}">

    <link rel="stylesheet" href="{{asset('vendor/chartist-js/chartist.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/chartist-js-tooltip/chartist-plugin-tooltip.css')}}">
...
<header id="js-header" class="u-header u-header--sticky-top">
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
                        ...
                        <ul class="p-0 mb-0">
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="img-temp/100x100/img5.jpg" alt="Image Description">
                                </div>
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="img-temp/100x100/img6.jpg" alt="Image Description">
                                </div>
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="img-temp/100x100/img7.jpg" alt="Image Description">
                                </div>
        ...
        <span class="u-badge-v2--xs u-badge--top-right g-hidden-sm-up g-bg-lightblue-v5 g-mr-5"></span>
                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="img-temp/130x130/img1.jpg" alt="Image description">
                </span>
            ...
            [
              ...
              {"meta": "$", "value": 2770}
                    ...
                    <div class="col-xl-4">
                        ...
                        <!-- Calendar Card -->
                        <div class="g-mb-30">
                            <header class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after g-rounded-4 g-rounded-0--bottom-left g-rounded-0--bottom-right g-overflow-hidden" style="background-image: url(img-temp/400x270/img3.jpg);">
                            ...
                            <div class="js-custom-scroll g-height-400 g-pa-15 g-pa-0-30-25--md">
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="img-temp/100x100/img5.jpg" alt="Image Description">
                                    </div>
              ...
              <span class="g-hidden-sm-down">Project</span>
                                ...
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="img-temp/100x100/img14.jpg" alt="Image Description">
                                    </div>
              ...
              <span class="g-hidden-sm-down">Project</span>
                                ...
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="img-temp/100x100/img7.jpg" alt="Image Description">
                                    </div>
...
<script src="{{asset('vendor/flatpickr/dist/js/flatpickr.min.js')}}"></script>
<script src="{{asset('vendor/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="{{asset('vendor/chartist-js/chartist.min.js')}}"></script>
<script src="{{asset('vendor/chartist-js-tooltip/chartist-plugin-tooltip.js')}}"></script>
...
<script src="{{asset('js/components/hs.area-chart.js')}}"></script>
<script src="{{asset('js/components/hs.donut-chart.js')}}"></script>
<script src="{{asset('js/components/hs.bar-chart.js')}}"></script>
