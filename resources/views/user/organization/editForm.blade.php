...
@section('active-main-menu-organization', 'opened')
...
@section ('appbottomjs')
	...
	<script>
		...
		$("#en_image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="{{ asset ($data->en_image) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be (10-1500)cmX(10-1500)cm with .jpg or .png type</i></span>',
		...
		$("#kh_image").fileinput({
		    ...
		    elErrorContainer: '#kv-avatar-errors-2',
		    msgErrorClass: 'alert alert-block alert-danger',
		    defaultPreviewContent: '<img src="{{ asset ($data->kh_image) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be (10-1500)cmX(10-1500)cm with .jpg or .png type</i></span>',
		    layoutTemplates: {main2: '{preview} ' +  btnCust + ' {remove} {browse}'},
		    allowedFileExtensions: ["jpg", "png", "gif"]
		});
	</script>
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="container-fluid">
					...
					@endif
					<form id="form" action="{{ route('user.organization.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
