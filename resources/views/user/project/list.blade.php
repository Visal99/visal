...
@section ('appbottomjs')
	<script type="text/javascript">
		...
		function updateStatus(id){
         	...
         	$.ajax({
		        url: "{{ route('user.project.update-status') }}",
		        method: 'POST',
	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(public_work!=""){
				url+='&public_work='+public_work;
			}

			$(location).attr('href', '{{ route('user.project.list') }}'+url);
		}
	</script>
@endsection
			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						<a href="{{ route('user.project.list') }}"  class="tabledit-delete-button btn btn-sm btn-success" style="float: none;"><span class="fa fa-refresh"></span></a>
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-5">
							<div class="form-group">
								...
								<select class="select2" id="public_work" class="form-control">
									<?php 
										$first='';
										$othersx='';
												...
												<td style="white-space: nowrap; width: 1%;">
													<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
			                                           	<div class="btn-group btn-group-sm" style="float: none;">
			                                           		<a href="{{ route('user.project.edit', $row->id) }}" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;"><span class="glyphicon glyphicon-pencil"></span></a>
			                                           		
			                                           		<a href="#" onclick="deleteConfirm('{{ route('user.project.trash', $row->id) }}', '{{ route('user.project.list') }}')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
			                                           	</div>
			                                       </div>
			                                    </td>
											</tr>
