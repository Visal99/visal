			...
			<div class="box-typical box-typical-padding">
				...
				<div class="tabs-section-nav tabs-section-nav-icons">
	                ...
	                @php ($feature = 0)
	               	...
	               	@endif
					<form id="form" action="{{ route('user.automation-system.store-document',$data->id) }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('PUT') }}
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="checkbox-toggle">
									<input name="publish" id="status" type="checkbox"   >
