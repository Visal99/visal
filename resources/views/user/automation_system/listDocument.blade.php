			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						...
						<a href="{{ route('user.automation-system.create-document', $data->id) }}"  class="tabledit-delete-button btn btn-sm btn-primary" style="float: none;"><span class="fa fa-plus"></span> Add New Regulation</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="tabs-section-nav tabs-section-nav-icons">
					<div class="tbl">
						<ul class="nav" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link active" onclick="window.location.href='{{ route('user.automation-system.list-document', ['id'=>$data->id,'slug'=>$data->slug]) }}'" href="#" role="tab" data-toggle="tab">
									<span class="nav-link-in">
														...
														<td style="white-space: nowrap; width: 1%;">
															<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
					                                           	<div class="btn-group btn-group-sm" style="float: none;">
					                                           		<a href="{{ route('user.automation-system.edit-document',['id'=>$row->id,'automation_system_id'=>$data->id]) }}" class="tabledit-edit-button btn btn-sm btn-success" style="float: none;"><span class="glyphicon glyphicon-pencil"></span></a>
			                                           		
			                                           			<a href="#" onclick="deleteConfirm('{{ route('user.automation-system.trash-document', $row->id) }}', '{{ route('user.automation-system.list-document',['id'=>$data->id,'slug'=>$data->slug]) }}')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
					                                           	</div>
					                                       </div>
					                                    </td>
													</tr>
