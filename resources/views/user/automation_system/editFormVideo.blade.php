...
@section ('appbottomjs')
	...
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="{{ asset($automation_video->image) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be (100-500)cmX(100-500)cm with .jpg or .png type</i></span>',
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="tabs-section-nav tabs-section-nav-icons">
					...
					@endif
					<form id="form" action="{{ route('user.automation-system.update-video',$data->id) }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						<input type="hidden" name="id" value="{{ $automation_video->id }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input 	id="en_title"
										name="en_title"
									   	value = "{{ $automation_video->en_title }}"
									   	type="text"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input 	id="kh_title"
										name="kh_title"
									   	value = "{{ $automation_video->kh_title }}"
									   	type="text"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input 	id="video_id"
										name="video_id"
									   	value = "{{$automation_video->video_id}}"
									   	type="text"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="checkbox-toggle">
									<input name="publish" id="publish" type="checkbox"  @if($automation_video->published ==1 ) checked @endif >
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								...
								<button type="button" onclick="deleteConfirm('{{ route('user.automation-system.trash-video', $automation_video->id) }}', '{{ route('user.automation-system.list-video',$data->id) }}')" class="btn btn-danger"> <fa class="fa fa-trash"></i> Delete</button>
							</div>
						</div>
					</form>
