			...
			<div class="tbl">
				<div class="tbl-row">
					...
					<div class="tbl-cell tbl-cell-action">
						...
						<a href="{{ route('user.automation-system.create-document',$data->id) }}"  class="tabledit-delete-button btn btn-sm btn-primary" style="float: none;"><span class="fa fa-plus"> Add New Regulation</span></a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="tabs-section-nav tabs-section-nav-icons">
					...
					@endif
					<form id="form" action="{{ route('user.automation-system.update-document') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								...
								<button type="button" onclick="deleteConfirm('{{ route('user.automation-system.trash-document', $document->id) }}', '{{ route('user.automation-system.list-document',['id'=>$data->id,'slug'=>$data->slug]) }}')" class="btn btn-danger"> <fa class="fa fa-trash"></i> Delete</button>
							</div>
						</div>
					</form>
