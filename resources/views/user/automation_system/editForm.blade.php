	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="container-fluid">
						...
						<div class="tabs-section-nav tabs-section-nav-icons">
							<div class="tbl">
								<ul class="nav" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" onclick="window.location.href='{{ route('user.automation-system.edit', $data->id) }}'" href="#" role="tab" data-toggle="tab">
					...
					@endif
					<form id="form" action="{{ route('user.automation-system.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						...
						<div class="form-group row">
							<label class="col-sm-2 form-control-label" for="ios_link">IOS Link</label>
							<div class="col-sm-10">
								<input 	id="ios_link"
										name="ios_link"
									   	value = "{{$data->ios_link}}"
									   	type="text"
									   	placeholder = "Eg. Tell your IOS Link "
									   	class="form-control"
									   	data-validation="[L>=1, L<=500]"
										data-validation-message="$ must be between 4and 50 characters. No special characters allowed." />
						...
						<div class="form-group row">
							<label class="col-sm-2 form-control-label" for="adroid_link">Android Link</label>
							<div class="col-sm-10">
								<input 	id="android_link"
										name="android_link"
									   	value = "{{$data->android_link}}"
									   	type="text"
									   	placeholder = "Eg. Tell your Android Link "
									   	class="form-control"
									   	data-validation="[L>=1, L<=500]"
										data-validation-message="$ must be between 4and 50 characters. No special characters allowed." />
						...
						<div class="form-group row">
							<label class="col-sm-2 form-control-label" for="frame">Frame</label>
							<div class="col-sm-10">
								<input 	id="frame"
										name="frame"
									   	value = "{{$data->frame}}"
									   	type="text"
									   	placeholder = "Google Map Frame URL "
									   	class="form-control" />
						...
						<div class="form-group row">
							<label class="col-sm-2 form-control-label" for="icon">Icon</label>
							<div class="col-sm-10">
								<div class="kv-avatar center-block">
