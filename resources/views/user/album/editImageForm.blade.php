...
@section ('appbottomjs')
	...
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="{{ asset ($data_image->image) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be (100-500)cmX(100-500)cm with .jpg or .png type</i></span>',
	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="tab-content">
					...
					@endif
					<form id="form" action="{{ route('user.album.update-image',['id'=>$data_image->id,'albumid'=>$data_image->album_id]) }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
