	...
	<div class="container-fluid">
			<div class="box-typical box-typical-padding">
				...
				<div class="tabs-section-nav tabs-section-nav-icons">
					<div class="tbl">
						<ul class="nav" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" onclick="window.location.href='{{ route('user.album.edit', $data->id) }}'" href="#" role="tab" data-toggle="tab">
							...
							<li class="nav-item">
								<a class="nav-link" onclick="window.location.href='{{ route('user.album.image', $data->id) }}'" href="#" role="tab" data-toggle="tab">
									<span class="nav-link-in">
				...
				<div class="tab-content">
					...
					@endif
					<form id="form" action="{{ route('user.album.update') }}" name="form" method="POST"  enctype="multipart/form-data">
						{{ csrf_field() }}
						{{ method_field('POST') }}
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								...
								<button type="button" onclick="deleteConfirm('{{ route('user.album.trash', $data->id) }}', '{{ route('user.album.list') }}')" class="btn btn-danger"> <fa class="fa fa-trash"></i> Delete</button>
							</div>
						</div>
					</form>
