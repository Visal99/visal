...
namespace App\Http\Controllers\CP\Popup;
...
use App\Model\Popup\Main as Model;
use Image;
class PopupController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $data = array(
                    ...
                    'display_period' =>  $request->input('display_period'),
        ...
        if($request->hasFile('image')) {
            ...
            Image::make($image->getRealPath())->resize(940, 600)->save(public_path('uploads/popup/image/'.$imagename));
    ...
    public function update(Request $request){
       ...
       Validator::make(
        ...
        if($request->hasFile('image')) {
            $image = $request->file('image');
            $imagename = time().'.'.$image->getClientOriginalExtension(); 
            Image::make($image->getRealPath())->resize(200, 200)->save(public_path('uploads/popup/image/'.$imagename));
            $data['img_url']='public/uploads/popup/image/'.$imagename;
        }
