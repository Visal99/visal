...
use App\Model\AutomationFaq\AutomationFaq as Model;
...
class AutomationLocationController extends Controller
{
    public function listData(){
        ...
        if(!empty($data)){
            ...
            return view('user.automation_faq.list', ['data'=>$data, 'automation_systems'=>$automation_systems]);
        }else{
    ...
    public function showCreateForm(){
        ...
        return view('user.automation_faq.createForm', ['automation_systems'=>$automation_systems]);
    }
    ...
    public function showEditForm($id = 0){
       ...
       $automation_systems = AutomationSystem::get();
        if(!empty($data)){
            return view('user.automation_faq.editForm', ['data'=>$data,'automation_systems'=>$automation_systems]);
        }else{
            return response(view('errors.404'), 404);
        }
    }
