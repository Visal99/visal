...
<?php $__env->startSection('section-title', 'Edit Image'); ?>
...
<?php $__env->startSection('section-js'); ?>
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="<?php echo e(asset($data->img_url)); ?>" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be free with .jpg or .png type</i></span>',
