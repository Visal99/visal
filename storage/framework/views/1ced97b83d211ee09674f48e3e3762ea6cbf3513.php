        <div class="content-column padd-t-b">
          <div class="page-header">
            <h1 class="text-center">CITIZEN SERVICES</h1>
          </div>
          <div class="">
            <div class="row citizen">
              <div class="museum-block1 col-md-12 col-xs-6">
                  <div class="inner-box1">
                      <div class="icon-box1">
                           <img src="<?php echo e(asset ('public/frontend/images/mpwt/automation/Vehicle_Registration.png')); ?>" class="img img-responsive margin_au">
                          <h3><a href="<?php echo e(route('automation-systems', ['locale'=>$locale, 'category'=>'vehicle-registration'])); ?>">Vehicle Registration</a></h3>
                      </div>
                  </div>
              </div>
