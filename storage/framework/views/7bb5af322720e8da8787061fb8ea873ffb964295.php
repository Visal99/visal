...
<?php $__env->startSection('title'); ?>
	Organization: <?php echo $__env->yieldContent('section-title'); ?>
	...
	<header class="page-content-header">
		<div class="container-fluid">
			<div class="tbl">
				<div class="tbl-row">
					<div class="tbl-cell">
						<h3>Organization <span> <i class="fa fa-long-arrow-right"></i> <?php echo $__env->yieldContent('section-title'); ?></span></h3> 
					</div>
