...
<?php $__env->startSection('content'); ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="breadcrumd"><small><a href="<?php echo e(route('home', $locale)); ?>"> <?php echo e(__('web.homepage')); ?></a> / <a href=""> <?php echo e(__('web.public-works')); ?> </a> / <a href="#"> <?php echo e($title); ?> </a>  </small></div>
      </div>
      <div class="col-md-8">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image item01">
                                    <a href="<?php echo e(route('project-view', ['locale'=>$locale, 'id'=>$row->id])); ?>"><img src="<?php echo e(asset ($row->image_url)); ?>" alt="" /></a>
                                </div>
                            </div>
                            <div class="content-boxproject">
                                <div class="upper-box">
                                   <a href="<?php echo e(route('project-view', ['locale'=>$locale, 'id'=>$row->id])); ?>"><?php echo e($row->title); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
