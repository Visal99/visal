<?php $__env->startSection('section-title', 'Project'); ?>
...
<?php $__env->startSection('tab-js'); ?>
	<script type="text/javascript">
			...
			function dragend(e){
				...
				console.log(string);
				$.ajax({
				        url: "<?php echo e(route($route.'.orders')); ?>",
				        type: 'POST',
				        data: {string:string},
			...
			<tbody>
				...
				<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr id="element-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>" class="moveable" feature-order="<?php echo e($row->data_order); ?>" draggable="true" ondragenter="dragenter(event)" ondragstart="dragstart(event)" ondragend="dragend(event)">
						...
						<td>
								<img style=" width: 200px;" src="<?php echo e(asset ($row->image_url)); ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="<?php echo e($row->en_title); ?>">
						</td>
						<td>
						...
						<td style="white-space: nowrap; width: 1%;">
							<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
	                           	<div class="btn-group btn-group-sm" style="float: none;">
	                           		...
	                           		<a href="#" onclick="deleteConfirm('<?php echo e(route($route.'.trash', ['id'=>$id, 'project_id'=>$row->id])); ?>', '<?php echo e(route($route.'.index', ['id'=>$id])); ?>')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
