<?php $__env->startSection('section-title', 'Create New Public Work'); ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="summernote-theme-1">
									<textarea id="kh_content" name="kh_content" class="form-control  summernote  "><?php echo e($kh_content); ?> </textarea>
								</div>	
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="summernote-theme-1">
									<textarea id="en_content" name="en_content" class="form-control  summernote  "> <?php echo e($en_content); ?></textarea>
								</div>	
							</div>
						</div>
