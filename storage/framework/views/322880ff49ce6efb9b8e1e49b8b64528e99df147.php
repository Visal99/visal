...
<?php $__env->startSection('section-title', 'All Public Services'); ?>
...
<?php $__env->startSection('section-js'); ?>
	...
	<script type="text/javascript">
			...
			function dragend(e){
				...
				console.log(string);
				$.ajax({
				        url: "<?php echo e(route($route.'.order-automation')); ?>",
				        type: 'POST',
				        data: {string:string},
				        success: function( response ) {
				         	if ( response.status === 'success' ) {
		...
		<tbody>
			...
			<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr id="element-<?php echo e($row->id); ?>" data-id="<?php echo e($row->id); ?>" class="moveable" feature-order="<?php echo e($row->data_order); ?>" draggable="true" ondragenter="dragenter(event)" ondragstart="dragstart(event)" ondragend="dragend(event)" >
					...
					<td>
							<img src="<?php echo e(asset ($row->icon)); ?>" alt="" data-toggle="tooltip" data-placement="bottom" title="<?php echo e($row->en_title); ?>">
					</td>
