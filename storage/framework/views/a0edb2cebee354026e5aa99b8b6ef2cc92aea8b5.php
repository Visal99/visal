						...
						<td style="white-space: nowrap; width: 1%;">
							<div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
	                           	<div class="btn-group btn-group-sm" style="float: none;">
	                           		...
	                           		<a href="#" onclick="deleteConfirm('<?php echo e(route($route.'.trash', ['id'=>$id, 'image_id'=>$row->id])); ?>', '<?php echo e(route($route.'.index', ['id'=>$id])); ?>')" class="tabledit-delete-button btn btn-sm btn-danger" style="float: none;"><span class="glyphicon glyphicon-trash"></span></a>
