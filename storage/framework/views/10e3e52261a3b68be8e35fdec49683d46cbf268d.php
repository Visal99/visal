...
@keyframes  fadeIn {
    ...
    <div class="container padd-t-b" >
        <div class="page-header">
            <h1 class="font-i2 padding-left1"><?php echo e(__('web.message-from-the-minister')); ?> </h1>
        </div>
        <div class="inner-news paddingtop5px">
          ...
          <div class="row padding15px">
            <!--<div class="col-md-5"><img src="<?php if(!empty($minister_message)): ?><?php echo e(asset ( $minister_message->image )); ?><?php endif; ?>"/></div>-->
