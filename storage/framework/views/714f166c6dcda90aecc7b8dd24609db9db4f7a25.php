...
<?php $__env->startSection('menu'); ?>
    ...
    <nav class="side-menu">
        ...
        <?php if(checkPermision('cp.dashboard') ): ?>
        ...
        <?php endif; ?>  
           ...
           <!--  <li class="<?php echo $__env->yieldContent('active-main-menu-banner'); ?> red with-sub">
            ...
            <?php if(checkPermision('cp.greeting.index')): ?>
            ...
            <?php endif; ?>
            <?php if(checkPermision('cp.content.content.edit,mission')): ?>
            <li class="<?php echo $__env->yieldContent('active-main-menu-about'); ?> red with-sub">
                ...
                <ul>
                    ...
                    <?php if(checkPermision('cp.content.content.edit,message-from-minister')): ?>
                    ...
                    <?php if(checkPermision('cp.biography.index')): ?>
            ...
            <?php if(checkPermision('cp.document.index')): ?>
             <li class="<?php echo $__env->yieldContent('active-main-menu-document'); ?> red with-sub">
                ...
                <ul>
                    ...
                    <?php if(checkPermision('cp.document-category.index')): ?>
            ...
            <?php if(checkPermision('cp.automation.index')): ?>
            ...
            <?php endif; ?>
            <?php if(checkPermision('cp.public_work.index')): ?>
            ...
            <?php endif; ?>
            <?php if(checkPermision('cp.contact')): ?>
            ...
            <?php endif; ?>
            <?php if(checkPermision('cp.banner.edit,1')): ?>
            <li class="<?php echo $__env->yieldContent('active-main-menu-setting'); ?> red with-sub">
                ...
                <ul>
                    ...
                    <?php if(checkPermision('cp.banner.edit,2')): ?>
                    <li class=""><a href="<?php echo e(route('cp.banner.edit',2)); ?>"><span class="lbl">Banner Mobile</span></a></li>
                    <?php endif; ?>

                    <?php if( checkPermision('cp.content.content.edit,seo-content')): ?>
