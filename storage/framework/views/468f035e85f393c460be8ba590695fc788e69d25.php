...
<?php $__env->startSection('section-title', 'Edit Greeting'); ?>
...
<?php $__env->startSection('section-js'); ?>
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="<?php echo e(asset($data->img_url)); ?>" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 940x605 with .jpg or .png type</i></span>',
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="summernote-theme-1">
						<textarea id="kh_description" name="kh_description" class="form-control "> <?php echo e($data->kh_description); ?></textarea>
					</div>	
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="summernote-theme-1">
						<textarea id="en_description" name="en_description" class="form-control "><?php echo e($data->en_description); ?> </textarea>
					</div>	
				</div>
			</div>
