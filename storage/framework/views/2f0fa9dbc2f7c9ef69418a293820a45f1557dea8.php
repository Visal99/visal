...
<?php if(isset($_GET['menu'])): ?>
    <?php ( $menu = $_GET['menu']); ?>
<?php endif; ?>
<?php $__env->startSection('active-main-menu-'.$menu, 'opened'); ?>
						...
						<?php if(isset($_GET['page'])): ?>
							<?php if($_GET['page'] != ""): ?>
							    ...
							    <?php if(isset($_GET['menu'])): ?>
							        <?php ( $menu = $_GET['menu']); ?>
							    <?php endif; ?>
								<a href="<?php echo e(route($route.'.list', ['page' => $_GET['page']])); ?>?menu=<?php echo e($menu); ?>&page=<?php echo e($_GET['page']); ?>" class="btn"><i class="fa fa-arrow-left"></i></a>
							<?php endif; ?>
						<?php endif; ?>
					</div>
				</div>
